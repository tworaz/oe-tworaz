...
DEPENDS = "gmtk gtk+ alsa-lib startup-notification glib-2.0 dbus-glib virtual/libx11 libxscrnsaver"
RDEPENDS = "mplayer2"
...
FILES_${PN} += "/usr/share/gnome-control-center/default-apps/${PN}.xml"
